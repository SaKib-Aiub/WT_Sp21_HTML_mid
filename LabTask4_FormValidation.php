	...
	$err_bio="";
		...
		if ($_SERVER["REQUEST_METHOD"] == "POST"){
			...
			if(empty($_POST["pass"]))
			 ...
			 {
				 $err_pass="*Password must contain special character";
			 }
			...
			if(empty($_POST["conpass"]))
			 {
				 $err_conpass="*Conformed Password Required";
			 }
...
<html>
	...
	<form action="" method="post">
			...
			<tr>
				...
				<td>
					<input type="checkbox" name="hear" value=""><?php echo $hear;?><span>A Friend or Colleague </span><br>
					<input type="checkbox" name="hear" value=""><?php echo $hear;?><span> Google </span><br>
